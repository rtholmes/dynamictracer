...
// * @author bsd
// */
//package edu.washington.cse.longan.staticTrace;
//
...
//import ca.ubc.cs.ferret.LRUFutureMap;
...
//    	}
//    	if(modelSearchCache == null) {
//            modelSearchCache = new LRUFutureMap<ResultKey,Object>(getCacheSize());
//    	} else {
...
//    	}
//        if(typeCache == null) {
//        	typeCache = new LRUFutureMap<String,IType>(getCacheSize());
//        } else {
